...
export const metadata: Metadata = {
  title: "Contact BlackMonkey – STEM Courses for Kids",
  description:
    "Contact BlackMonkey with questions about STEM courses, enrollment, or partnerships.",
  openGraph: {
    title: "Contact BlackMonkey – STEM Education",
    description:
      "Get in touch with the BlackMonkey team about courses, enrollment, or collaborations.",
    type: "website",
  },
};
