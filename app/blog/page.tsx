...
export const metadata: Metadata = {
  title: "STEM Insights Blog – BlackMonkey",
  description:
    "Explore tutorials, guides, and stories about robotics, IoT, drones, and paper circuits for kids.",
  openGraph: {
    title: "STEM Insights Blog – BlackMonkey",
    description:
      "Explore tutorials, tips, and stories from the BlackMonkey STEM community.",
    type: "website",
  },
};
