...
export async function generateMetadata({
  ...
  if (!course) {
    return {
      title: "Course not found – BlackMonkey",
      description: "The requested course could not be found on BlackMonkey.",
    };
  }

  const title = `${course.name} – ${course.code} | BlackMonkey`;
  const description = course.fullDescription ?? course.tagline;
